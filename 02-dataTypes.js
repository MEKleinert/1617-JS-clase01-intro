...
//ahora lo reasignamos y convertimos en numero!
variable1 = 15;
console.log(typeof variable1);
...
//boolean: solo true or false
let esVerdad = false;
console.log(esVerdad);

//array: guarda cosas en orden. Con los [] le decimos que es un array
let frutas = ["banana", "frutilla", "pera", 25, true];
console.log(typeof frutas);

//objetos: similar al array, pero ademas, es un par nombre: valor. Lo hacemos con {}
let persona = {
  ojos: 2,
  piernas: 2,
  cabeza: 1,
